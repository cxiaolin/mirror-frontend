...
import style from '../../../../resources/CleanStyles/Core/style/stories.scss'
...
export default class Progress extends React.PureComponent {
  ...
  render() {
    ...
    switch (this.props.active) {
      ...
      case 1:
        innerStyle = {
          animation: `${this.state.duration}ms linear 0ms ${style.slidein}`,
    ...
    return (
      ...
      >
        <div
          ...
          style={
            innerStyle
          } /* style={{...styles.overlay, width: `${this.props.completed * 100}%`}} */
        />
      </div>
    )
  }

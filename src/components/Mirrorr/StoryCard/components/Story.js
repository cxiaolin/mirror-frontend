...
import globalStyle from '../../../../resources/CleanStyles/Core/style/stories.scss'
  ...
  render() {
    ...
    return (
      <div style={{ ...styles.story, width: this.props.width, height: this.props.height }}>
        {!this.props.story.expired && type === 'image' && (
          <img style={styles.storyContent} src={source} onLoad={this.imageLoaded} />
        )}
        {!this.props.story.expired && type === 'video' && (
          <video
            ref={r => {
              this.vid = r
            }}
        ...
        {this.props.story.expired && (
          ...
          >
            <h2 style={{ color: 'red' }}>story expired</h2>
          </div>
        )}
      </div>
    )
